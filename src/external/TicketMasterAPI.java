...
public class TicketMasterAPI implements ExternalAPI{
	...
	private static final String API_KEY = "0vufaExmfALkApDGhpnhA52E3euKkus4";
	
	@Override
	public List<Item> search(double lat, double lon, String term) {    // term is the keywords
...
// response body is saved in InputStream of connection.// code is status of Request.
			int responseCode = connection.getResponseCode();
			System.out.println("\nSending 'GET' request to URL : " + url + "?" + query);
			System.out.println("Response Code : " + responseCode);

// Now read response body to get events data //from the client viewpoint
	...
	private String urlEncodeHelper(String term) {
		try {
			term = java.net.URLEncoder.encode(term, "UTF-8"); // convert string(your input) to url
		} catch (Exception e) {
			e.printStackTrace();
		}
		return term;
